...
public class Model {
    public Model() {
        //  Creates Football Player Object
        FootballPlayer F1 = new FootballPlayer(52, "Ryan Bates", "G/C",
                new Height(6, 4), 284, "Warrington, Pa.");
        FootballPlayer F2 = new FootballPlayer(11, "Brandon Bell", "LB",
                new Height(6, 1), 231, "Mays Landing, N.J.");
        FootballPlayer F3 = new FootballPlayer(91, "Nick Boumerhi", "PK",
                new Height(5, 9), 173, "Phillipsburg, Pa.");
